...
@section('page_title', 'My Active / Pending Bookings')

@section('content')
<div class="card border-0 shadow-sm">
    <div class="card-header bg-white py-4 px-4 border-0">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h5 class="fw-bold mb-0">Active & Pending Bookings</h5>
        </div>
        
        <!-- Filters Area -->
        <form action="{{ route('staff.bookings.pending') }}" method="GET" class="row g-3 align-items-end">
            <div class="col-md-4">
            ...
            <div class="col-md-2">
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('staff.bookings.pending') }}" class="btn btn-light border w-100"><i class="bi bi-arrow-counterclockwise"></i></a>
                </div>
            </div>
        </form>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="9" class="text-center py-5">
                            ...
                            <p class="text-muted">No active/pending bookings found in your record.</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
