    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-8">
                ...
                <a href="{{ route('packages.custom') }}" class="text-sm font-medium hover:text-[#c6a664] transition-colors">Make Your Package</a>
                ...
                @else
                    ...
                    <a href="#" class="bg-[#c6a664] text-white px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-[#b59554] transition-all shadow-lg">Get App</a>
                @endauth
            </div>
    ...
    <div id="drawer-content" class="absolute right-0 top-0 bottom-0 w-80 bg-white translate-x-full transition-transform duration-500 flex flex-col">
        ...
        <div class="p-8 flex-1 overflow-y-auto">
            ...
            <nav class="space-y-6">
                ...
                <a href="{{ route('packages.custom') }}" class="block text-lg font-bold text-[#3d2b1f] hover:text-[#c6a664] transition-colors">Make Your Package</a>
                @auth
