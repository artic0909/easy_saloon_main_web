...
@section('meta_description', 'Enjoy our exclusive ' . $package->name . '. A curated collection of premium beauty services designed for your ultimate grooming experience.')
            ...
            <div class="w-full lg:w-[450px]">
                <div class="bg-[#3d2b1f] rounded-[3rem] p-10 md:p-12 shadow-2xl sticky top-40" 
                    ...
                    <div class="grid grid-cols-2 gap-4 mt-4">
                        <a href="https://wa.me/919999999999?text=Hello%20Esy%20Saloon,%20I%20want%20to%20book%20{{ rawurlencode($package->name) }}%20package." target="_blank" class="w-full bg-white/10 text-white border border-white/20 py-4 rounded-[2rem] font-bold text-sm shadow-lg hover:bg-white/20 transition-all transform active:scale-95 flex items-center justify-center gap-2">
