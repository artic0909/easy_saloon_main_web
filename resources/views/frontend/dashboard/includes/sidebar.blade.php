<div class="bg-white rounded-[3rem] p-10 shadow-xl shadow-gray-200/50 border border-gray-100/50 sticky top-40">
    ...
    <nav class="space-y-3">
        ...
        <a href="{{ route('dashboard.wallet') }}" class="flex items-center gap-4 px-6 py-4 rounded-2xl {{ $currentRoute == 'dashboard.wallet' ? 'bg-[#3d2b1f] text-white shadow-xl shadow-[#3d2b1f]/20' : 'text-gray-500 hover:bg-gray-50' }} font-bold transition-all group">
            <svg class="w-5 h-5 {{ $currentRoute == 'dashboard.wallet' ? 'text-[#c6a664]' : 'text-gray-400 group-hover:text-[#3d2b1f]' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path></svg>
