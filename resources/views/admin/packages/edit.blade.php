...
@section('page_title', 'Edit Service Package')
                ...
                <form action="{{ route('admin.packages.update', $package->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-4">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="name" class="form-control bg-light border-0 py-3 px-4 rounded-4" value="{{ $package->name }}" required>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="sale_price" class="form-control bg-light border-0 py-3 px-4 rounded-4" value="{{ $package->sale_price }}" required>
                        </div>

                        <div class="col-12">
                            <label class="form-label fw-bold text-dark">Package Details</label>
                            <textarea name="details" rows="4" class="form-control bg-light border-0 py-3 px-4 rounded-4 summernote" required>{{ $package->details }}</textarea>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            @if($package->image)
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $package->image) }}" class="rounded-4 shadow-sm" style="height: 120px; width: 100%; object-fit: cover;">
                                </div>
                            @endif
                            <div class="p-4 border-2 border-dashed rounded-4 text-center bg-light">
                                <i class="bi bi-cloud-arrow-up fs-1 text-muted"></i>
                                <div class="mt-2 small text-muted">Click to change image or drag and drop</div>
